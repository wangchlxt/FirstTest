...
namespace Redis
{
    ...
    public class RedisHelper
    {
        ...
        private TimeSpan defaultExpiry = TimeSpan.FromDays(1.2);//默认缓存时间
        ...
        /// 模糊查找keys
        /// </summary>
        /// <param name="ptn">匹配表达式，如"ug:*"</param>
        /// <returns></returns>
        public List<RedisKey> KeysScan(string ptn)
        {
            var server = _conn.GetServer(_conn.GetEndPoints()[0]);
            var valores = server.Keys(pattern: ptn);
