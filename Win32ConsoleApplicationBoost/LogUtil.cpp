...
boost::log::sources::severity_logger<boost::log::trivial::severity_level > CLogUtil::s_slg;
...
void CLogUtil::Init(const string& dir)
{
...
void CLogUtil::Log(const string& msg)
{
	src::logger lg;
	BOOST_LOG(lg) << msg;
}
