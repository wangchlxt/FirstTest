    ...
    public class HttpService
    {
        ...
        public static string Post(string xml, string url, bool isUseCert, int timeout)
        {
            ...
            try
            {
                ...
                * ************************************************************/
                ...
                if (isUseCert)
                {
                    ...
                    X509Certificate2 cert = new X509Certificate2(path + ConfigurationManager.AppSettings["WechatSecretFile"], ConfigurationManager.AppSettings["WechatSecretFilePwd"]);
            ...
            catch (System.Threading.ThreadAbortException e)
            {
                ...
                LogHelper.Error("Exception message: {0}", e);
                System.Threading.Thread.ResetAbort();
            }
            catch (WebException e)
            {
                LogHelper.Error("HttpService", e);
